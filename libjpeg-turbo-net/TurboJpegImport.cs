...
namespace TurboJpegWrapper
{
    static class TurboJpegImport
    {
        ...
        /// </list>
        /// </summary>
        public static readonly Dictionary<TJSubsamplingOptions, tjSize> MCUSizes = new Dictionary<TJSubsamplingOptions, tjSize>
        {
            { TJSubsamplingOptions.TJSAMP_GRAY, new tjSize(8, 8) },
            { TJSubsamplingOptions.TJSAMP_444, new tjSize(8, 8) },
            { TJSubsamplingOptions.TJSAMP_422, new tjSize(16, 8) },
            { TJSubsamplingOptions.TJSAMP_420, new tjSize(16, 16) },
            { TJSubsamplingOptions.TJSAMP_440, new tjSize(8, 16) },
            { TJSubsamplingOptions.TJSAMP_411, new tjSize(32, 8) },
        };
        ...
        [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl, EntryPoint = "tjTransform")]
